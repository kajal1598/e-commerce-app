...
class HomeItemWidget extends StatelessWidget {
  HomeItemWidget(this.homeItemModelObj, {this.onTapColumnwarmerssweater});

  HomeItemModel homeItemModelObj;

  var controller = Get.find<HomeController>();

  VoidCallback? onTapColumnwarmerssweater;
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      textAlign: TextAlign.left,
                      style:
                          AppStyle.txtInterSemiBold12DeeporangeA200.copyWith(),
                    ),
                  ),
                ],
              ),
